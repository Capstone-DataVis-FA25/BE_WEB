...
export class ChartsController {
  ...
  @ApiOperation({
    ...
    description:
      "Create a new chart for a specific dataset. The dataset must belong to the authenticated user.",
  })
  @ApiResponse({ status: 201, description: "Chart created successfully" })
  @ApiResponse({
    status: 403,
    description: "Forbidden - dataset access denied",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all charts created by the authenticated user with their datasets and decrypted data headers, ordered by creation date (newest first).",
  })
  @ApiResponse({
    status: 200,
    description: "List of charts retrieved successfully",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all charts created from a specific dataset with their datasets and decrypted data headers. The dataset must belong to the authenticated user.",
  })
  @ApiResponse({
    status: 200,
    description: "List of charts for dataset retrieved successfully",
  })
  @ApiResponse({
    status: 403,
    description: "Forbidden - dataset access denied",
  ...
  @ApiParam({
    name: "datasetId",
    description: "ID of the dataset to get charts for",
  })
  findByDataset(
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve a chart by its ID along with the associated dataset and decrypted data headers. The chart must belong to the authenticated user.",
  })
  @ApiResponse({
    status: 200,
    description: "Chart detail retrieved successfully",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Update a chart by its ID. The chart must belong to the authenticated user.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Delete a chart by its ID. The chart must belong to the authenticated user.",
  })
